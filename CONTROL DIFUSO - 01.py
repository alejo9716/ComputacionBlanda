...
#servicio y de la camida de una restaurante
...
#Visalizar estos universos y funciones de pertenencia
...
ax1.set_title('Valor de la propina')
ax1.legend()
...
#Ocultar los ejes supero / derecho
...
#Necesitamos la activasión de nuestras funciones de pertenencia difusa en estos valores
#Los valores exactos 6.5 y 9.8 no existen en nuestros universos....
#Para es existe fuzz.interp_membership
...
#El operador OR significa que tomammos el máximo de estos dos
...
ax0.set_title('Activadad de menresía de salida')
...
ax0.set_title('Membresía agragada y resultado (línea)')

#Cancelos los ejes superior / derecho
for ax in (ax0, ):
  ax.spines['top'].set_visible(False)
  ax.spines['right'].set_visible(False)
  ax.get_xaxis().tick_bottom()
